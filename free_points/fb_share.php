...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v13.0&appId=677693956781379&autoLogAppEvents=1" nonce="ooEWqEE2"></script>  
  </head>
<body>
<?php
$j=0;
...
// Display the array elements
 ...
 <p><em><b>To get free points by sharing other's Facebook Pages click on the ''share'' button, then the page will be opened with popUp and after like the page CLOSE the popUp yourself. The users who don't close manually the popUp, will not receive points.</b></em></p>



<div class="fb-share-button" id="api" data-href="" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.facebook.com%2Fthuggoatsclub&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Partager</a></div> </br><?php 
foreach ($tableau_php as $i => $value) {
        
           echo "  tu vas gagner  $cpctab[$i] points  pour partager cet url : $tableau_php[$i] <br/>";  
           }
